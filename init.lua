...
-- Set highlight on search, but clear on pressing <CR> in normal mode
...
require('lazy').setup({
...

  {
    ...
    opts = {
      -- ~/.local/share/nvim/lazy/Comment.nvim/lua/Comment/init.lua
      -- bind Ctrl-/ to comment toggle
      toggler = {
        line = '<C-_>',
      },
      opleader = {
